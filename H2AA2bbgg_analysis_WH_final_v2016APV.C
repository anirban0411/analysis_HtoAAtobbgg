...
float* Get_PU_Weights(TFile *file_pu_ratio, int npu){
  ...
  float pho_no, pho1pt, pho1y, pho1eta, pho1phi, pho1e, pho2pt, pho2y, pho2eta, pho2phi, pho2e, dipho_invmass, pho1MVA, pho2MVA;
...
int main(int argc, char *argv[])
{
	...
	if(inputFile=="new_v3_2016/WHmA20_2016PreAPV_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/signal/2016APV/WH_mA_20_0000_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="new_v3_2016/WHmA55_2016PreAPV_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/signal/2016APV/WH_mA_55_0000_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="new_v3_2016/TTGJets_2016PreAPV_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/TTGJets/2016APV/WH/TTGJets_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="new_v3_2016/DYJetsToLL_M50_2016PreAPV_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/DYJetsToLL/2016APV/WH/DYJetsToLL_M50_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="new_v3_2016/TTTo2L2Nu_2016PreAPV_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/TTTo2L2Nu/2016APV/WH/TTTo2L2Nu_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="new_v3_2016/TTToSemiLeptonic_2016PreAPV_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/TTSL/2016APV/WH/TTSL_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="new_v2_2016/SingleElectron_2016PreAPVB_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/SinEle/2016APV/SingleElectron_2016B_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="new_v2_2016/SingleElectron_2016PreAPVC_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/SinEle/2016APV/SingleElectron_2016C_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="new_v2_2016/SingleElectron_2016PreAPVD_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/SinEle/2016APV/SingleElectron_2016D_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="new_v2_2016/SingleElectron_2016PreAPVE_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/SinEle/2016APV/SingleElectron_2016E_%s_%s.root",argv[1],argv[2]);
        }

	else if(inputFile=="new_v2_2016/SingleElectron_2016PreAPVF_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/SinEle/2016APV/SingleElectron_2016F_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="new_v2_2016/SingleMuon_2016PreAPVB_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/SinMu/2016APV/SinMu_2016B_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="new_v2_2016/SingleMuon_2016PreAPVC_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/SinMu/2016APV/SinMu_2016C_%s_%s.root",argv[1],argv[2]);
        }

	else if(inputFile=="new_v2_2016/SingleMuon_2016PreAPVD_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/SinMu/2016APV/SinMu_2016D_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="new_v2_2016/SingleMuon_2016PreAPVE_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/SinMu/2016APV/SinMu_2016E_%s_%s.root",argv[1],argv[2]);
        }

	else if(inputFile=="new_v2_2016/SingleMuon_2016PreAPVF_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/SinMu/2016APV/SinMu_2016F_%s_%s.root",argv[1],argv[2]);
        }
...
//	  if (nmu == 1) {
	  ...
	  if (isMu) {
          leptonvec.SetPtEtaPhiE(Muon_pt[MuIndex], Muon_eta[MuIndex], Muon_phi[MuIndex], fabs(Muon_p[MuIndex])); }
...
//          event_weight = 1.0;
          ...
          weight_nom = event_weight * puWeight * prefiringweight * leptonsf_weight * PFJetAK4_btag_DeepFlav_SF[0] * PFJetAK4_btag_DeepFlav_SF[1];

          weight_PU_up = event_weight * puWeightup * prefiringweight * leptonsf_weight * PFJetAK4_btag_DeepFlav_SF[0] * PFJetAK4_btag_DeepFlav_SF[1];
          weight_leptonsf_up = event_weight * puWeight * prefiringweight * leptonsf_weight_up * PFJetAK4_btag_DeepFlav_SF[0] * PFJetAK4_btag_DeepFlav_SF[1];
          weight_bSF_up = event_weight * puWeight * prefiringweight * leptonsf_weight * PFJetAK4_btag_DeepFlav_SF_up[0] * PFJetAK4_btag_DeepFlav_SF_up[1];
          weight_prefiring_up = event_weight * puWeight * prefiringweightup * leptonsf_weight * PFJetAK4_btag_DeepFlav_SF[0] * PFJetAK4_btag_DeepFlav_SF[1];
//	  weight_trig_up = event_weight * puWeight * prefiringweight * leptonsf_weight * PFJetAK4_btag_DeepFlav_SF[0] * PFJetAK4_btag_DeepFlav_SF[1];

          weight_PU_dn = event_weight * puWeightdown * prefiringweight * leptonsf_weight * PFJetAK4_btag_DeepFlav_SF[0] * PFJetAK4_btag_DeepFlav_SF[1];
          weight_leptonsf_dn = event_weight * puWeight * prefiringweight * leptonsf_weight_dn * PFJetAK4_btag_DeepFlav_SF[0] * PFJetAK4_btag_DeepFlav_SF[1];
          weight_bSF_dn = event_weight * puWeight * prefiringweight * leptonsf_weight * PFJetAK4_btag_DeepFlav_SF_dn[0] * PFJetAK4_btag_DeepFlav_SF_dn[1];
	  weight_prefiring_dn = event_weight * puWeight * prefiringweightdown * leptonsf_weight * PFJetAK4_btag_DeepFlav_SF[0] * PFJetAK4_btag_DeepFlav_SF[1];
//	  weight_trig_dn = event_weight * puWeight * prefiringweight * leptonsf_weight * PFJetAK4_btag_DeepFlav_SF[0] * PFJetAK4_btag_DeepFlav_SF[1];
          }      
