...
int main(int argc, char *argv[])
{
	...
	if(inputFile=="new_v3_2016/ZHmA20_2016PostAPV_new_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/signal/2016/ZH/ZH_mA_20_0000_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="new_v3_2016/ZHmA55_2016PostAPV_new_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/signal/2016/ZH/ZH_mA_55_0000_%s_%s.root",argv[1],argv[2]);
        }
        ...
        else if(inputFile=="new_v2_2016/DoubleEG_2016PostAPVF_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/DoubEG/2016/DoubleEG_2016F_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="new_v2_2016/DoubleEG_2016PostAPVG_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/DoubEG/2016/DoubleEG_2016G_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="new_v2_2016/DoubleEG_2016PostAPVH_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/DoubEG/2016/DoubleEG_2016H_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="new_v2_2016/DoubleMuon_2016PostAPVF_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/DoubMu/2016/DoubleMuon_2016F_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="new_v2_2016/DoubleMuon_2016PostAPVG_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/DoubMu/2016/DoubleMuon_2016G_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="new_v2_2016/DoubleMuon_2016PostAPVH_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/DoubMu/2016/DoubleMuon_2016H_%s_%s.root",argv[1],argv[2]);
        }
