...
file3.open("condor_WH_mA_55.sh",ios::out);
...
for(int i=1; i <= 38; i =i+2)
{
   ...
   if(!file1)
   {
       ...
       return 0;
         ...
         file1 << "universe = vanilla\nexecutable = exe_file/exe_WH_mA_55_" << i <<"_"<< j << ".sh\ngetenv = TRUE\nlog =/home/abala/t3store3/Higgs/others/WH_mA_55_" << i <<"To"<<j<<".log\noutput =/home/abala/t3store3/Higgs/others/WH_mA_55_" << i <<"To"<<j<<".out\nerror =/home/abala/t3store3/Higgs/others/WH_mA_55_" << i <<"To"<<j<<".error\nnotification = never\nshould_transfer_files = YES\nwhen_to_transfer_output = ON_EXIT\nqueue";
