...
int main(int argc, char *argv[])
{
	...
	if(inputFile=="new_v3_2016/ZHmA20_2016PreAPV_new_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/signal/2016APV/ZH/ZH_mA_20_0000_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="new_v3_2016/ZHmA55_2016PreAPV_new_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/signal/2016APV/ZH/ZH_mA_55_0000_%s_%s.root",argv[1],argv[2]);
        }
        ...
        else if(inputFile=="new_v2_2016/DoubleEG_2016PreAPVB_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/DoubEG/2016APV/DoubleEG_2016PreAPVB_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="new_v2_2016/DoubleEG_2016PreAPVC_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/DoubEG/2016APV/DoubleEG_2016PreAPVC_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="new_v2_2016/DoubleEG_2016PreAPVD_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/DoubEG/2016APV/DoubleEG_2016PreAPVD_%s_%s.root",argv[1],argv[2]);
        }

	else if(inputFile=="new_v2_2016/DoubleEG_2016PreAPVE_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/DoubEG/2016APV/DoubleEG_2016PreAPVE_%s_%s.root",argv[1],argv[2]);
        }

	else if(inputFile=="new_v2_2016/DoubleEG_2016PreAPVF_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/DoubEG/2016APV/DoubleEG_2016PreAPVF_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="new_v2_2016/DoubleMuon_2016PreAPVB_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/DoubMu/2016APV/DoubleMuon_2016PreAPVB_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="new_v2_2016/DoubleMuon_2016PreAPVC_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/DoubMu/2016APV/DoubleMuon_2016PreAPVC_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="new_v2_2016/DoubleMuon_2016PreAPVD_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/DoubMu/2016APV/DoubleMuon_2016PreAPVD_%s_%s.root",argv[1],argv[2]);
        }

	else if(inputFile=="new_v2_2016/DoubleMuon_2016PreAPVE_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/DoubMu/2016APV/DoubleMuon_2016PreAPVE_%s_%s.root",argv[1],argv[2]);
        }

 	else if(inputFile=="new_v2_2016/DoubleMuon_2016PreAPVF_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/DoubMu/2016APV/DoubleMuon_2016PreAPVF_%s_%s.root",argv[1],argv[2]);
        }
   ...
   T1->SetBranchAddress("hlt_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass3p8",&hlt_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass3p8);
  ...
  T1->SetBranchAddress("LHE_weight",&LHE_weight);
    ...
    for(int iev=0; iev<nevents; iev++)
    {
	  ...
	  //--------------------------------------------------------------------------trigger info---------------------------------------------------------------------//
          ...
          if (!(hlt_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL || hlt_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ || hlt_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass3p8 || hlt_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL || hlt_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ || hlt_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL || hlt_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ)) continue;
...
//	  if (nElectron >= 2) {
	  ...
	  isMu = false;
          ...
          if (hlt_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass3p8 || hlt_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL || hlt_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ || hlt_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL || hlt_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ) {
          cut_flow_mu->Fill(1);
