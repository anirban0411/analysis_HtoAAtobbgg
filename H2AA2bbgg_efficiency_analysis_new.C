...
int main(int argc, char *argv[])
{
        ...
        if(inputFile=="HAHMHToAA_To2B2G_MA_55GeV_v2.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/eff_new_trigger/55GeV/HAHMHToAA_To2B2G_MA_55GeV_v2_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="HAHMHToAA_To2B2G_MA_40GeV_v2.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/eff_new_trigger/40GeV/HAHMHToAA_To2B2G_MA_40GeV_v2_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="HAHMHToAA_To2B2G_MA_20GeV_v2.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/eff_new_trigger/20GeV/HAHMHToAA_To2B2G_MA_20GeV_v2_%s_%s.root",argv[1],argv[2]);
        }
...
//---------------------------------------------------------------------------------------------------------------------------//
		...
		for(int i=0; i<nphotons; i++)
		{
                ...
                //        if (phopt[i] < 20) continue;
                        if (fabs(phoeta[i]) > 1.5) continue;
			if (fabs(phoeta[i]) > 1.44 && fabs(phoeta[i]) < 1.5) continue;
		...
		subleadphovec.SetPtEtaPhiE(phopt[1], phoeta[1], phophi[1], phoe[1]);
                ...
                if (leadphovec.Pt() < 22) continue;
                if (subleadphovec.Pt() < 14) continue;
