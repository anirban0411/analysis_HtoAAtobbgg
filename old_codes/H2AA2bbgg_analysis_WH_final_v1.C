...
float* Get_PU_Weights(TFile *file_pu_ratio, int npu){
  ...
  float Muon_charge[njetmx], Muon_p[njetmx], Muon_pt[njetmx], Muon_eta[njetmx], Muon_phi[njetmx], Muon_dz[njetmx], Muon_ip3d[njetmx], Muon_ptErr[njetmx], Muon_chi[njetmx], Muon_ecal[njetmx], Muon_hcal[njetmx];
...
int main(int argc, char *argv[])
{
	...
	if(inputFile=="all_log_files/WH_mA_20_test.log"){
        ...
        else if(inputFile=="all_log_files/TTGJets_new_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/TTGJets/2018/WH/electron/TTGJets_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="all_log_files/TTGG_0Jets_new_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/TTGG/2018/WH/electron/TTGG_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="all_log_files/DYJetsToLL_M50_new_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/DYJetsToLL/2018/WH/electron/DYJetsToLL_M50_0000_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="all_log_files/TTTo2L2Nu_0000_new_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/TTTo2L2Nu/2018/WH/electron/TTTo2L2Nu_0000_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="all_log_files/TTTo2L2Nu_0001_new_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/TTTo2L2Nu/2018/WH/electron/TTTo2L2Nu_0001_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="all_log_files/TTToSemiLeptonic_0000_new_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/TTSL/2018/WH/electron/TTSL_0000_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="all_log_files/TTToSemiLeptonic_0001_new_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/TTSL/2018/WH/electron/TTSL_0001_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="all_log_files/TTToSemiLeptonic_0002_new_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/TTSL/2018/WH/electron/TTSL_0002_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="all_log_files/TTToSemiLeptonic_0003_new_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/TTSL/2018/WH/electron/TTSL_0003_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="all_log_files/TTToSemiLeptonic_0004_new_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/TTSL/2018/WH/electron/TTSL_0004_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="all_log_files/TTToSemiLeptonic_0005_new_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/TTSL/2018/WH/electron/TTSL_0005_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="all_log_files/ST_t_channel_antitop_new_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/ST_t_channel_antitop/2018/WH/electron/ST_t_channel_antitop_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="all_log_files/ST_t_channel_top_new_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/ST_t_channel_top/2018/WH/electron/ST_t_channel_top_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="all_log_files/ST_tW_antitop_new_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/ST_tW_antitop/2018/WH/electron/ST_tW_antitop_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="all_log_files/ST_tW_top_new_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/ST_tW_top/2018/WH/electron/ST_tW_top_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="all_log_files/WJetsToLNu_new_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/WJetsToLNu/2018/WH/electron/WJetsToLNu_%s_%s.root",argv[1],argv[2]);
        }
        ...
        else if(inputFile=="all_log_files/EGamma_2018A_0000_new_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/egamma/egamma_2018A_0000_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="all_log_files/EGamma_2018A_0001_new_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/egamma/egamma_2018A_0001_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="all_log_files/EGamma_2018A_0002_new_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/egamma/egamma_2018A_0002_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="all_log_files/EGamma_2018B_0000_new_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/egamma/egamma_2018B_0000_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="all_log_files/EGamma_2018B_0001_new_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/egamma/egamma_2018B_0001_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="all_log_files/EGamma_2018C_0000_new_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/egamma/egamma_2018C_0000_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="all_log_files/EGamma_2018C_0001_new_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/egamma/egamma_2018C_0001_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="all_log_files/EGamma_2018D_0000_new_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/egamma/egamma_2018D_0000_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="all_log_files/EGamma_2018D_0001_new_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/egamma/egamma_2018D_0001_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="all_log_files/EGamma_2018D_0002_new_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/egamma/egamma_2018D_0002_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="all_log_files/EGamma_2018D_0003_new_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/egamma/egamma_2018D_0003_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="all_log_files/EGamma_2018D_0004_new_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/egamma/egamma_2018D_0004_%s_%s.root",argv[1],argv[2]);
        }

        else if(inputFile=="all_log_files/EGamma_2018D_0005_new_v1.log"){
                sprintf(fOut,"/home/abala/t3store3/Higgs/egamma/egamma_2018D_0005_%s_%s.root",argv[1],argv[2]);
        }
...
//	  if (nmu != 1) continue;
	  ...
	  if (isEle) {
          leptonvec.SetPtEtaPhiE(Electron_pt[EleIndex], Electron_eta[EleIndex], Electron_phi[EleIndex], Electron_e[EleIndex]); }

	  if (isMu) {
          leptonvec.SetPtEtaPhiE(Muon_pt[MuIndex], Muon_eta[MuIndex], Muon_phi[MuIndex], Muon_p[MuIndex]); }
...
/*
          int looseB_bb = 0;
          for(int i=2; i<nPFJetAK4; i++)
          {
                  if (PFJetAK4_btag_DeepFlav[i] > 0.0490) 
                  {
                        looseB_bb++; 
                  }
          }
